 ...
 */
public class CMChineseLotto extends DriverManager
{
    public void cmChineseLotto() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("CM Chinese Lotto")).click();
