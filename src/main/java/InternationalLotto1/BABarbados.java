 ...
 */
public class BABarbados extends DriverManager
{
    public void baBarbados() throws InterruptedException

    {
        ...
        driver.findElement(By.linkText("BA Barbados")).click();
