 ...
 */
public class CLCanadianLottoBet extends DriverManager
{

    public void clCanadianLottoBet() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("CL Canadian Lotto Bet")).click();
        ...
        // Void a draw
        // clicking on CL Canadian Lotto Bet
        driver.findElement(By.linkText("CL Canadian Lotto Bet")).click();
