 ...
 */
public class RSRussian extends DriverManager
{
    public void rsRussian() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("RS Russian")).click();
