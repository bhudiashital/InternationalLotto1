 ...
 */
public class STSingaporeToto extends DriverManager
{
    public void stSingapore() throws InterruptedException

    {
        ...
        driver.findElement(By.linkText("ST Singapore (Toto)")).click();
