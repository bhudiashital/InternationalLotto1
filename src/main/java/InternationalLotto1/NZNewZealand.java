 ...
 */
public class NZNewZealand extends DriverManager
{
    public void nzNewZealand () throws InterruptedException
    {
        ...
        lotto.selectByValue("NZ");

        Utilities utilities = new Utilities();
        utilities.addAdhocDraw1();
        ...
        driver.findElement(By.linkText("NZ New Zealand")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[37]")).click();
        ...
        System.out.println("2 number selected");
        ...
        //--------------------------------------------------------------------------------------------------------------
        // Change Pending
        // clicking on GL German Lotto Bet
        driver.findElement(By.linkText("NZ New Zealand")).click();
        ...
        System.out.println("1 NEW number selected");
