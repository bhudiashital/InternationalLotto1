 ...
 */
public class PWIndianLotto extends DriverManager
{
    public void pwIndianLottoBet() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("PW Indian Lotto (Playwin)")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[2]/button[3]")).click();
        // 6 Standard Numbers are Selected as per the Game Rule, using a single click
