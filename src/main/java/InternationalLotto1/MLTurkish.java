 ...
 */
public class MLTurkish extends DriverManager {
    public void mlTurkish() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("ML Turkish")).click();
