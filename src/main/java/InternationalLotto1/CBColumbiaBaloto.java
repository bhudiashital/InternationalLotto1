 ...
 */
public class CBColumbiaBaloto extends DriverManager
{

    public void cbColumbiaBaloto () throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("CB Columbia Baloto")).click();
