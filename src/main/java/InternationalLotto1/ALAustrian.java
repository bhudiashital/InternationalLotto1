 ...
 */
public class ALAustrian extends DriverManager
{

    public void alAustrian() throws InterruptedException {
    ...
    Select lotto = new Select(sportcode);
        ...
        driver.findElement(By.linkText("AL Austrian")).click();
