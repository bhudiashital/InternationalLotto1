 ...
 */
public class PLPolish extends DriverManager
{

    public void plPolish() throws InterruptedException

    {
        ...
        driver.findElement(By.linkText("PL Polish")).click();
