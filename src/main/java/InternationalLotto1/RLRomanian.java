 ...
 */
public class RLRomanian extends DriverManager
{
    public void rlRomanian() throws InterruptedException
    {
       ...
       //-----------------------------------------------------------------------------------------------------------------
        ...
        driver.findElement(By.linkText("RL Romanian")).click();
