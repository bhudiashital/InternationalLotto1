...
/**
 * Created by SBhudia on 31/03/2017.
 */
public class GPAtlantaGeorgiasPowerBall extends DriverManager
{
    public void gpAtlantaGeogiasPowerBall() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("GP Atlanta - Georgias Power Ball")).click();
       ...
       // 5 Standard Numbers are Selected from Section 1
        ...
        //--------------------------------------------------------------------------------------------------------------
        // Change Pending
        // clicking on GP Atlanta - Georgias Power Ball
        driver.findElement(By.linkText("GP Atlanta - Georgias Power Ball")).click();
        ...
        System.out.println("1 NEW standard number selected from section 2");
