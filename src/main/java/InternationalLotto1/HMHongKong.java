 ...
 */
public class HMHongKong extends DriverManager
{

    public void hmHongKongMark6() throws InterruptedException

    {
        ...
        driver.findElement(By.linkText("HM Hong Kong (mark 6)")).click();
