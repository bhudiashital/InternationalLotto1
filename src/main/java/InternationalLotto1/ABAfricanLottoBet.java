 ...
 */
public class ABAfricanLottoBet extends DriverManager
{
    public void abAfrican() throws InterruptedException

    {
       ...
       System.out.println("You are now on Home page");
        ...
        driver.findElement(By.linkText("AB African Lotto Bet")).click();
