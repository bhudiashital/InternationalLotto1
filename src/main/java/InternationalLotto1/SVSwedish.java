 ...
 */
public class SVSwedish extends DriverManager
{
    public void svSwedish() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("SV Swedish")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[5]")).click();
        ...
        System.out.println("7 standard numbers selected");
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[11]")).click();
        element = null;
        action = new Actions(driver).doubleClick(element);
        action.build().perform();
        System.out.println("4 Bonus numbers selected");
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[13]")).click();
        element = null;
        action = new Actions(driver).doubleClick(element);
        action.build().perform();

        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[14]")).click();
        element = null;
        action = new Actions(driver).doubleClick(element);
        action.build().perform();

        System.out.println("4 NEW Bonus numbers selected");
        //--------------------------------------------------------------------------------------------------------------
