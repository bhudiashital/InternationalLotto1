 ...
 */
public class NYNewYorkLottoBet extends DriverManager
{

    public void nyNewYorkLotto() throws InterruptedException

    {
       ...
       //-----------------------------------------------------------------------------------------------------------------
        ...
        driver.findElement(By.linkText("NY New York Lotto Bet")).click();
