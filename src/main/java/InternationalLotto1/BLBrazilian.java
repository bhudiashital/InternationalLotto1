...
/**
 * Created by SBhudia on 21/03/2017.
 */
public class BLBrazilian extends DriverManager
{
    public void blBrazilian() throws InterruptedException

    {
        ...
        driver.findElement(By.linkText("BL Brazilian")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[58]")).click();
