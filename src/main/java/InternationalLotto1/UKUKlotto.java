 ...
 */
public class UKUKlotto extends DriverManager
{
    public void ukUKlotto() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("UK UK lotto")).click();
