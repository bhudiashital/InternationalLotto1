 ...
 */
public class OLGreek extends DriverManager
{
    public void olGreek() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("OL Greek")).click();
