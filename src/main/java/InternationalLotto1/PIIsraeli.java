 ...
 */
public class PIIsraeli extends DriverManager
{
    public void piIsraeli() throws InterruptedException
    {
        ...
        driver.findElement(By.linkText("PI Israeli")).click();
