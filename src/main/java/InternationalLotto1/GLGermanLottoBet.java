 ...
 */
public class GLGermanLottoBet extends DriverManager
{
    public void glGermanLotto() throws InterruptedException {
        ...
        driver.findElement(By.linkText("GL German Lotto Bet")).click();
