 ...
 */
public class EMEuroMillions extends DriverManager
{
    public void emEuroMillions() throws InterruptedException {
        ...
        driver.findElement(By.linkText("EM Euro Millions")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[2]/div/div/button[5]")).click();
        ...
        System.out.println("5 NEW standard numbers selected from Section 2");

        // 2 numbers selected from section 2
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[2]/div/div/button[12]")).click();
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[2]/div/div/button[8]")).click();
        System.out.println("2 NEW standard numbers selected from Section 2");
