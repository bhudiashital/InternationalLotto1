 ...
 */
public class SZSwitzerland extends DriverManager
{
    public void szSwitzerland() throws InterruptedException
    {
       // Clicking on Create Draw
        ...
        driver.findElement(By.linkText("SZ Switzerland")).click();
        ...
        System.out.println("1 number selected");
