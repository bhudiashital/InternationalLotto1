 ...
 */
public class SEItalianSuperEnalotto extends DriverManager
{
    public void seItalian() throws InterruptedException

    {
        ...
        driver.findElement(By.linkText("SE Italian (Super Enalotto)")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[85]")).click();
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[7]")).click();
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[80]")).click();
        System.out.println("6 standard numbers selected");

        // Result Page : 1 Bonus number is selected using double click.
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[70]")).click();
        ...
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[80]")).click();
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[9]")).click();
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[71]")).click();
        driver.findElement(By.xpath("//*[@id=\"l-main\"]/div[1]/div/div/button[90]")).click();
